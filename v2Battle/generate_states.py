...
def generate_states(num_states, output_dir, gb_path="PokemonRed.gb", state_dir="v2Battle/battle_states", headless=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output-dir", type=str, default="v2Battle/battle_states", help="Directory to save states")
    parser.add_argument("--gb-path", type=str, default="PokemonRed.gb", help="Path to Pokemon Red ROM")
    parser.add_argument("--state-dir", type=str, default="v2Battle/battle_states", help="Directory containing base save states")
