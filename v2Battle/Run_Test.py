...
if __name__ == "__main__":
    ...
    env_config = {
        ...
        "gb_path": "../PokemonRed.gb" if not os.path.exists("PokemonRed.gb") else "PokemonRed.gb",
        "debug": False,
        # Give it a perfectly clean battle state instead of dropping it at the Nintendo Logo!
        "init_state": str(Path(__file__).parent / "battle_states/Test/battle_Brock.state"),
    ...
    ckpt = get_latest_checkpoint("runs")
    if ckpt is None:
